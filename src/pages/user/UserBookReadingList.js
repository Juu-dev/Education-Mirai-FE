...
export const UserBookReadingList = () => {
    ...
    return (_jsxs("div", { className: "container mx-auto px-4 overflow-hidden", children: [_jsx(FilterSection, { filters: filters, onFilterChange: handleFilterChange }), _jsx("div", { className: "book-list-wrapper mb-4 overflow-auto", children: _jsx(BookList, { isRefresh: false }) })] }));
};
