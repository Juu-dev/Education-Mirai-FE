...
const LibrarianDocumentPage: React.FC = () => {
  ...
  return (
    <div className="p-5">
      ...
      <Modal title="Lựa chọn template" open={isChooseTemplateModalVisible} onCancel={handleCancelChooseTemplateModal} footer={null}>
      ...
      <Modal title="Thêm mẫu mới" open={isAddTemplateModalVisible} onCancel={handleCancelAddTemplateModal} footer={null}>
        <div className="mb-4">
