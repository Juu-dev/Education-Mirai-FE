...
export const AssignmentComponent: React.FC<AssignmentComponentProps> = ({ assignment, gotoDetailPage }) => {
    return (
        <div className="col-lg-4 col-md-6 col-12 p-4">
            ...
            <div className="bg-white shadow-lg rounded-lg h-full flex flex-col p-6" data-aos="fade-up">
                {/* Title */}
                <h3 className="text-xl font-semibold mb-4 text-black">{assignment?.name}</h3>
